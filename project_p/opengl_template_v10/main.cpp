...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("opengl template v11");
    ...
    DefaultModel* default_model = new DefaultModel("obj/BlockQuestion.obj", "BlockQuestion", "box", glm::scale(glm::mat4(1.0f), glm::vec3(4.0, 4.0, 4.0))); // 실제 모델 가져오기
